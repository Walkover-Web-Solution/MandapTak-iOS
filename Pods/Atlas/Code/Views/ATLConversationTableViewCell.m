...
- (void)lyr_commonInit
{
    ...
    _conversationTitleLabel.font =[UIFont fontWithName:@"MYRIADPRO-REGULAR" size:16];;
    _conversationTitleLabel.textColor = [UIColor darkGrayColor];
...
- (void)setConversationTitleLabelFont:(UIFont *)conversationTitleLabelFont
{
    ...
    _conversationTitleLabelFont = [UIFont fontWithName:@"MYRIADPRO-REGULAR" size:16];
    self.conversationTitleLabel.font = [UIFont fontWithName:@"MYRIADPRO-REGULAR" size:16];
}

- (void)setConversationTitleLabelColor:(UIColor *)conversationTitleLabelColor
{
    _conversationTitleLabelColor = [UIColor darkGrayColor];
    self.conversationTitleLabel.textColor = [UIColor darkGrayColor];
}
...
{
    _dateLabelFont = [UIFont fontWithName:@"MYRIADPRO-REGULAR" size:14];
    self.dateLabel.font = [UIFont fontWithName:@"MYRIADPRO-REGULAR" size:14];;
}

- (void)setDateLabelColor:(UIColor *)dateLabelColor
{
    _dateLabelColor = [UIColor lightGrayColor];
