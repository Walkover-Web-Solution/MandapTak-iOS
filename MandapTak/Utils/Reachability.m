...
static void ReachabilityCallback(SCNetworkReachabilityRef target, SCNetworkReachabilityFlags flags, void* info) {
	...
	@autoreleasepool {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [[NSNotificationCenter defaultCenter] postNotificationOnMainThreadWithName:kReachabilityChangedNotification object:(__bridge  Reachability *)info userInfo:nil];
        });
	}
