...
- (void)viewDidLoad
{
    ...
    self.topLabelSpaceConstraint.constant = [UIScreen mainScreen].bounds.size.height > 480.0f ? 61 : 31;
...
-(void)viewDidLayoutSubviews
{
    ...
    userImageView.layer.cornerRadius = userImageView.layer.frame.size.width/2; //85.0f;
    userImageView.layer.borderWidth = 3.0f;
    userImageView.layer.borderColor = [[UIColor whiteColor]CGColor];//[[UIColor colorWithRed:242/255.0f green:112/255.0f blue:114/255.0f alpha:1] CGColor];
    userImageView.clipsToBounds = YES;
    
    imageViewBackground.layer.cornerRadius = imageViewBackground.layer.frame.size.width/ 2;
}
